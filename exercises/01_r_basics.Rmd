...
**Exercise 2:** Let's do an excerise together create a new element "A" with an upper case to the number 3. Notice in your environment you will have two objects.
...
Above I used base R colors that are rapped in quotes. For the full list of all possible base R colors here is a link to a list. [Base R Colors](chrome-extension://efaidnbmnnnibpcajpcglclefindmkaj/http://www.stat.columbia.edu/~tzheng/files/Rcolor.pdf)
