...
# If you have not done the prep work please run the following line of code. 
# install.packages("readxl","tidyverse","DT","plotly","shiny","knitr","flexdashboard")
...
__Exercise 2:__ Find a function we haven't used yet using any of the following resources and apply it to the vector "v". 
